...
const Intro = () => {
    ...
    <div className='col-lg-6 col-sm-12 p-lg-3 p-3 mt-lg-5 mt-3'>
            ...
            <div className='col-lg-3 col-sm-6 p-2 p-lg-3 mt-lg-5'>
                <img className='w-100  border-1 rounded' src={img1} alt="side img-1" />
            </div>
            <div className='col-lg-3 col-sm-12   p-2 p-lg-3 mt-lg-5'>   
